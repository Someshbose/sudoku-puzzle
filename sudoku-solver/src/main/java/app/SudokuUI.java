...
public class SudokuUI extends JFrame {
  ...
  /*
   * Button b=new Button("Click Here"); b.setBounds(50,100,80,30);
   */
  // cp.add(b);
  ...
  private class InputListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      /*
       * Assume that the solution is unique. Compare the input number with the number in the
       * puzzle[rowSelected][colSelected]. If they are the same, set the background to green (Color.GREEN); otherwise,
      ...
      /*
       * Check if the player has solved the puzzle after this move. You could update the masks[][] on correct guess, and
       * check the masks[][] if any input cell pending.
       */
