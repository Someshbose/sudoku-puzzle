  ...
  static boolean solveSudoku(int grid[][]) {
    ...
    for (int n = 1; n <= 9; n++) {
      if (isSafe(grid, i, j, n) == true) {
        grid[i][j] = n;
        /*
         * for each safe n=1 to 9, call solveSudoku to check if using a particular n in an empty cell proceeds towards
         * solution
         */
        ...
        /*
         * if particular n in an empty cell doesn't proceed towards solution, then backtrack using n=n+1
         */
        grid[i][j] = 0;
      }
    }
